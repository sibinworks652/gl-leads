<div class="row g-3">
    @if (! $readonlyMode)
        ...
        <div class="col-md-6 input-margin">
            ...
            <select class="form-select @error('source') is-invalid @enderror" id="lead-source-{{ $lead->id ?: 'new' }}" name="source">
        ...
        <div class="col-md-6 input-margin">
            ...
            <select class="form-select @error('assigned_user_id') is-invalid @enderror" id="lead-assigned-{{ $lead->id ?: 'new' }}" name="assigned_user_id">
    ...
    <div class="col-md-{{ $readonlyMode ? '12' : '6' }} input-margin">
        ...
        <select class="form-select @error('status') is-invalid @enderror" id="lead-status-{{ $lead->id ?: 'new' }}" name="status" required>
